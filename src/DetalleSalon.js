...
function DetalleSalon() {
  ...
  const imagenUrl = `https://econo2-almendros.s3.amazonaws.com/${extraerNombreImagen(detalles["Salón"])}.jpg`;
          ...
          <div className="p-6">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="bg-gray-700 rounded-xl p-6 shadow-sm card-hover border border-gray-600">
                ...
                {imageError ? (
                  <div className="flex-1 flex flex-col items-center justify-center bg-gray-800 rounded-lg p-6 text-center border border-gray-600">
                    <svg className="w-16 h-16 text-gray-500 mb-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"></path>
                    </svg>
                    <p className="text-gray-400">Imagen no disponible</p>
                  </div>
                ) : (
                  <div className="flex-1 flex items-center justify-center bg-gray-800 rounded-lg overflow-hidden border border-gray-600">
                    <img
                      src={imagenUrl}
